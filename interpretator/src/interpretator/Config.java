...
public class Config {
	...
	public static final OperationInterpretator[] operationInterpretators = { new VarDeclarationOperationInterpretator(),
			new OutOperationInterpretator(), new OutlnOperationInterpretator(), new InOperationInterpretator(),
			...
			new WhileOperationInterpretator(), new BreakOperationInterpretator(), new DoWhileOperationInterpretator(),
			new ForOperationInterpretator(), new ReturnOperationInterpretator(),
	...
	private static final ExpressionResolver[] expressionResolvers = { new ArrayEmptyDeclarationExpressionResolver(),
			new ArrayWithValuesDeclarationExpressionResolver(), new ArrayLengthExpressionResolver(),
			new ArrayElementByIndexExpressionResolver(), singleExpressionResolver, functionExpressionResolver,
	...
	public static final FunctionStorageBuilder functionStorageBuilder = new FunctionStorageBuilderImpl(tokenParser,
